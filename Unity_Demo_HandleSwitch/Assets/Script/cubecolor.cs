...
public class cubecolor : MonoBehaviour {
	...
	void Update ()
    {
        handle_press(0, txt, "手柄0：");
        handle_press(1, txt4,"手柄1：");
        ...
        /* if (Controller.Upvr_ControllerTriggerClick(0))
         {
             txt.text = "主手柄:" + "Trigger按钮被按下";
         }
         if (Controller.Upvr_ControllerTriggerClick(1))
         {
             txt4.text = "副手柄:" + "Trigger按钮被按下";
         }*/
    ...
    public void handle_electric(int num,Text txt)
    {
        ...
        switch (num)
        {
            case 0:
                ...
                txt.text = "主手柄电量为：" + dian.ToString();
                break;
            case 1:
                int dian1 = Controller.UPvr_GetControllerPower(1);
                txt.text = "副手柄电量为：" + dian1.ToString();
                break;
            default:
                break;
        }
    ...
    public void handle_position(int num, Text txt)
    {
        ...
        if (num == 0)
        {
            ...
            txt.text = "手柄0位置：" + "x:" + x.ToString() + " ,y:" + y.ToString() + " ,z:" + z.ToString();
        }
        if (num == 1)
        {
            txt.text = "手柄1位置：" + "x:" + x.ToString() + " ,y:" + y.ToString() + " ,z:" + z.ToString();
        }
    }
